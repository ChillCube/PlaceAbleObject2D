...
A node that for object placement in Godot
...
```bash
clone-gd-addon https://github.com/ChillCube/PlaceAbleObject2D.git
```

## Documentation
You can find the documentation at: https://github.com/ChillCube/PlaceAbleObject2D/blob/main/DOCUMENTATION.md

## Deinstallation
### Linux
Run this in the root of your godot project:
```bash
remove-gd-addon PlaceAbleObject2D
```
